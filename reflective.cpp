...
int main()
{
    ...
    // -------------------------
    Shader shader("E:/CS7GV3/Assignment/Project/Project/Project/Shader/cubemaps.vert", "E:/CS7GV3/Assignment/Project/Project/Project/Shader/cubemaps.frag");
    ...
    // build and compile shaders
    // -------------------------
    Shader BallShader("E:/CS7GV3/Assignment/Project/Project/Project/Shader/ballmaps.vert", "E:/CS7GV3/Assignment/Project/Project/Project/Shader/ballmaps.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        Ball = glm::translate(Ball, glm::vec3(3.0f, 0.0f, 0.0f)); // translate it down so it's at the center of the scene
        Ball = glm::scale(Ball, glm::vec3(1.0f));	// it's a bit too big for our scene, so scale it down
        BallShader.setMat4("model", Ball);
        BallShader.setMat4("view", view);
        BallShader.setMat4("projection", projection);
        BallShader.setFloat("dispersion", dispersion);
        BallShader.setVec3("cameraPos", camera.Position);
